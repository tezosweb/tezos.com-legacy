...
A balance for a public key hash that was recommended an allocation will not appear on a [Tezos block explorer](https://tzstats.com) until it has been activated. After a contributor has activated its recommended allocation, it may view the “Store and Use” page for information regarding storing and using its Tezos tokens (“tez”).
